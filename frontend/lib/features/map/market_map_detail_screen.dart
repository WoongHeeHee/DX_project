      ...
      body: Stack(
        children: [
          ...
          DraggableScrollableSheet(
            ...
            initialChildSize: _midSize, // 디폴트: 화면의 2/5 (40%)
            minChildSize: _minSize, // 최소: 인디케이터만 보일 정도
            maxChildSize: _maxSize, // 최대: 거의 전체 화면
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildLocationButtonForSaved(responsive, textTheme),
                      SizedBox(
